...
public interface SpaceRepositoryCustom {
	...
	List<SpaceSearchDto> findSpaceByName(String name, String sort, Long memberId);
	List<SpaceSearchDto> findSpaceByKeywords(String type, String subType, String purpose, String mood, String music, String interior, String visitor, String optServ, String dish, String dishDesc, String sort, Long memberId);
